...
<div class="container mx-auto px-4 md:px-9 min-h-[70vh] py-10">
  <h1 class="h1 mb-10">{$t("roadmap")}</h1>
  ...
  {#each index2s as key, i}
    <div class="flex flex-row items-center">
      ...
      <div
        class="bg-surface-100 w-1/3 line-x {i % 2 == 0 && 'transform180'}"
      ></div>
  ...
  {#if mod == 0}
    <div
      class="flex {index2s.length - (1 % 2) ? 'flex-row' : 'flex-row-reverse'}"
    >
      <div class="flex flex-row justify-center w-1/3" style="height: 6rem">
        <div class="card p-4 w-1/3">
  ...
  {:else}
    <div class="flex flex-row items-center">
      ...
      <div
        class="bg-surface-100 w-1/3 line-x {0 % 2 == 0 && 'transform180'}"
      ></div>
      <div class="card p-4 w-1/3">
        <div class="p-2 flex flex-row justify-center" style="height: 10rem;">
          <img alt="launch" style="height: 8rem;" src="/img/launch.png" />
