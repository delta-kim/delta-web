			...
			<div class="flex flex-row justify-evenly mb-8 md:mb-20 lg:w-5/6">
				<figure class="w-2/6 pt-1">
					<a
						target="_blank"
						href={lang == "zh-CN"
							? "https://punks.oss-ap-southeast-1.aliyuncs.com/mobile_app_apk/delta_mobile_1.0.9.apk"
							: "https://raw.githubusercontent.com/delta-kim/document/main/mobile_app_apk/delta_mobile_1.0.9.apk"}
					>
						<img
							class="border-2 rounded-md w-full card-hover"
							src="/img/android_apk.png"
					...
					<div style="font-size: xx-small">
						Latest version:1.0.9<br />Date:2025-02-26
					</div>
				</figure>
				<figure class="w-2/6">
					<a
