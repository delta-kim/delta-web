...
<section
  class="2xl:px-9 h-full flex flex-col justify-center items-center py-20"
>
      ...
      <div class="flex flex-row items-center gap-8 mb-10">
        <figure class="mt-7">
          <a
            target="_blank"
            href={lang == "zh-CN"
              ? "http://8.138.24.79/delta_mobile_1.1.5.apk"
              : "https://github.com/delta-kim/delta_mobile_app/releases/download/1.1.5/delta_mobile_1.1.5.apk"}
          >
            <img
          ...
          <div style="font-size:xx-small " class="text-center">
            <a
              ...
              target="_blank">Version:1.1.5 Latest:2025-04-06</a
            >
          </div>
        </figure>
        <figure>
