  ...
  const explore_apps = [
    {
      ...
      link: "./whitepaper#3.4_3-no-verification",
    },
    {
    ...
    },
    {
      ...
      link: "./whitepaper#3.2_mobile_phone_mining",
    },
    {
      ...
      link: "./whitepaper#2.3_energy_consumption_and_environmental_issues",
    },
    {
      ...
      link: "./whitepaper#3.5_safety_circle",
    },
    {
      ...
      link: "./whitepaper#3.6_economic_model",
    },
    {
      ...
      link: "./whitepaper#3.15_decentralized_multi-chain_wallet",
    },
    {
      image: "/img/Web3.svg",
      alt: "Web3",
      ...
      link: "./whitepaper#3.10_dapp_square",
    },
    {
      ...
      link: "./whitepaper#3.16_technical_solutions_and_implementation",
    },
    {
      image: "/img/DAO.svg",
      alt: "DAO",
      ...
      subtitle: $t("ICP_smart_blockchain_desc"),
      link: "./whitepaper#4.3.2_dao_mode",
    },
  ];
</script>
